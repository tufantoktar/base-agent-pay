...
export async function handleStockAnalysisAuditRequest(req, res, options = {}) {
  ...
  if (req.method !== "GET") {
    return sendJson(res, 405, {
      ...
      message: "Only GET is supported for stock analysis audit lookup.",
    });
  }
  ...
  try {
    ...
    return sendJson(res, 200, {
      ok: true,
      audit: publicStockAuditRecord(record),
    });
  } catch {
    return sendJson(res, 500, {
      ...
      message: "Stock analysis audit lookup failed closed.",
    });
  } finally {
